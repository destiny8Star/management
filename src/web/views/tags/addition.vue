                ...
                <div class="content">
                     <el-form :model="data" :rules="rules" ref="data" label-width="100px">
                         <el-row class="tab-btn-box">
                             <el-col :span="12">
                                 <el-button @click="selectCode(0)" round :autofocus="true">首页标签</el-button>
                                 <el-button @click="selectCode(1)" round>借款标签</el-button>
                                 <el-button @click="selectCode(2)" round>信用卡标签</el-button>
                             </el-col>
                         </el-row>
        ...
        submit (formName) {
            ...
            that.$refs[formName].validate((valid) => {
                if (valid) {
                    that.isSubmit = true; 
                    setTimeout(() => {
                        Tags.addition({ ...that.data }).then((res) => {
                            if (res) {
                                if (res.code === 10001) {
