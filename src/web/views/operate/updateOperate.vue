<template>
    <div id="updateOperate">
        <el-container direction="vertical" v-loading="isSubmit">
            <el-main>
                <div class="content">
                    <el-button @click="$router.push('/operate')" class="back" type="text"><i
                    ...
                    <el-card class="box-card">
                        ...
                        <div class="row">
                            <!--提示语：（不在app中显示）-->
                            <p>广告名称：</p>
                            <el-input v-model="title" placeholder="请输入广告名称"></el-input>
                        </div>
                        <div class="row">
                            <p>排序：</p>
                            <el-input v-model="sortNum" placeholder="越小越靠前"></el-input>
                        </div>
                        <div class="row">
                    ...
                    <el-card class="box-card">
                        ...
                        <div class="row">
                            <p>广告类型：</p>
                            <!--<span class="typeText" v-show="!type">广告类型</span>-->
                            ...
                            <el-input class="inputT" v-show="type==2" v-model="goodsNo" placeholder="请输入商品货号"></el-input>
...
<script>
    ...
    const map = {1: '首页顶部轮播', 2: '首页中部小banner', 3: '我的中部banner'};
    export default {
        name: "updateOperate",
        data() {
            return {
                adId: '',//广告id
                location: '请在广告列表页选定广告位置',//广告位置
                locations: '',//广告位置-调参
                title: '',//广告标题
                sortNum: '',//广告权重排序
                isSubmit: false,
        ...
        methods: {
            ...
            save() {
                ...
                if(this.locations == '请在广告列表页选定广告位置'){
                    this.open('请前往广告列表页');
                    return false;
                }
                if(this.title==''){
                ...
                this.$confirm("此操作将修改该广告 , 是否继续 ?", "提示", {
                    "confirmButtonText": "确定",
                    "cancelButtonText": "取消",
                    "type": "warning",
                }).then(() => {
             ...
             */
            getDetail(){
                Operate.advertisingDetail({"id":this.adId}).then(res=>{
                    console.log(res);
                    if(res.code==200){
