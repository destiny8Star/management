            ...
            <el-main>
                <div class="content">
                    <div class="screen-box">
                        ...
                        <!--<div class="upgrade" @click="$router.push('/userCenter/addAgent')">-->
                            <!--<img src="../../../../assets/img/views/userCenter/zs.png" alt="">-->
                            <!--<span>升级执行服务商</span>-->
                        <!--</div>-->
                    </div>
                    <!-- 表格 -->
                    <div class="table-box">
                        <el-table
                            ...
                            <el-table-column prop="tel" label="账户" width="94">
                            </el-table-column>
                            ...
                            <el-table-column  prop=amountlabel="累计收入" >
                            </el-table-column>
                            <el-table-column prop="balance" label="账户余额">
                            </el-table-column>
                            <el-table-column label="操作" fixed="right" width="72">
                                <template slot-scope="scope">
        ...
        data(){
            return {
                ...
                "postData":{
                    ...
                    "endTime": '',//结束日期
                    "type": '',//input输入框类型
                    "portType": 2//【1：vip用户，2：执行服务商，3：县级合伙人，4：城市合伙人 】
                },
                //input输入框类型选择
                "inputOptions": [
                    {
