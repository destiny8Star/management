<!--
  - recommendSP Vue
  - @JsName recommendSP  == recommend-share-profit
  - @Description 累计收入-推荐分润视图.
                ...
                <div class="content">
                    ...
                    <div class="tableBox">
                        <el-table
                            ...
                            <el-table-column prop="shareAmount" label="收款金额(元)" >
                            </el-table-column>
                            <el-table-column prop="shareProfitType" label="分润详情" >
                                <template slot-scope="scope">{{ scope.row.spDetail}}</template>
                            </el-table-column>
