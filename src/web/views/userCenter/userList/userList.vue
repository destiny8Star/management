                ...
                <div class="content">
                    <div class="screen-box">
                        ...
                        <div class="select-box">
                            <el-radio-group v-model="postData.isAuth">
                                <el-radio :label="2">全部用户</el-radio>
                                <el-radio :label="1">已实名用户</el-radio>
                                <el-radio :label="0">未实名用户</el-radio>
                            </el-radio-group>
                            <el-button @click="search" type="primary" size="small">筛选</el-button>
                        </div>
                    </div>
                    ...
                    <div class="table-box">
                        <el-table
                            ...
                            <el-table-column label="邀请人">
                                <template slot-scope="scope">
                                    <span>{{scope.row.inviteName?scope.row.inviteName:'--'}}</span>
                                </template>
                            </el-table-column>
                            ...
                            <el-table-column label="操作" fixed="right" width="160">
                                <template slot-scope="scope">
                                    <el-button type="text" sixe="small" @click="deliverClick(scope.row)">查看用户详情</el-button>
                                </template>
                            </el-table-column>
                        </el-table>
                        <!--表格结束-->
    ...
    export default {
        ...
        methods: {
            ...
            getData(){
                ...
                UserCenter.userList(this.postData).then(res=>{
                    console.log(res);
                    if(res.code==200){
