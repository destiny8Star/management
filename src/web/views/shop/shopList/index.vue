            ...
            <el-main>
                <div class="content">
                    <div class="screen-box">
                        ...
                        <div class="select-box">
                            <el-radio-group @change="changeState" v-model="postData.status">
                                <el-radio :label="0">平台商铺</el-radio>
                                <el-radio :label="1">下架商铺</el-radio>
                            </el-radio-group>
                            <el-button @click="search" type="primary" size="small">筛选</el-button>
                        </div>
                    </div>
                    ...
                    <div class="table-box">
                        <el-table
                            ...
                            <el-table-column prop="storeUserName" label="商铺户主">
                                <template slot-scope="scope">
                                    <span>{{scope.row.storeUserName  ?scope.row.storeUserName  :'--'}}</span>
                                </template>
                            </el-table-column>
                            <el-table-column label="线上商品(件)">
                                <template slot-scope="scope">
                                    <span>{{scope.row.goodNo ?scope.row.goodNo :'0'}}</span>
                                </template>
                            </el-table-column>
                            ...
                            <el-table-column label="操作" fixed="right" width="160">
                                <template slot-scope="scope">
                                    <el-button type="text" sixe="small" @click="deliverClick(scope.row)">查看商铺详情</el-button>
                                </template>
                            </el-table-column>
                        </el-table>
                        <!--表格结束-->
    ...
    export default {
        ...
        methods: {
            ...
            getData(){
                ...
                Shops.shopList(this.postData).then(res=>{
                    console.log(res);
                    if(res.code==200){
            ...
            deliverClick (data) {
                var that = this;
                console.log(data);
                that.$router.push({path:'/shop/shopDetail',query:{shopId:data.id}})
            },
        },
        beforeCreate () {
        },
